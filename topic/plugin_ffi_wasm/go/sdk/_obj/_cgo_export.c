...
extern void _cgoexp_dfc451a857ba_Echo(void *, int, __SIZE_TYPE__);

CGO_NO_SANITIZE_THREAD
People* Echo(People* p)
{
	...
	_cgo_a.p0 = p;
	_cgo_tsan_release();
	crosscall2(_cgoexp_dfc451a857ba_Echo, &_cgo_a, 16, _cgo_ctxt);
	_cgo_tsan_acquire();
...
CGO_NO_SANITIZE_THREAD
void _cgo_dfc451a857ba_Cfunc__Cmalloc(void *v) {
	struct {
