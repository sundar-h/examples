...
for t in $@; do
  ...
  echo "=== ${t} ==="
  if [ -e "/mnt/hgfs/sanghaifa/data/examples/topic/rust-memory-leak/target/debug/build/jemalloc-sys-315785adf64e61f1/out/jemalloc/${t}.sh" ] ; then
    ...
    enable_fill=1 \
    enable_prof=0 \
    . /mnt/hgfs/sanghaifa/data/examples/topic/rust-memory-leak/target/debug/build/jemalloc-sys-315785adf64e61f1/out/jemalloc/${t}.sh && \
    export_malloc_conf && \
    $JEMALLOC_TEST_PREFIX ${t} /mnt/hgfs/sanghaifa/data/examples/topic/rust-memory-leak/target/debug/build/jemalloc-sys-315785adf64e61f1/out/jemalloc/ /mnt/hgfs/sanghaifa/data/examples/topic/rust-memory-leak/target/debug/build/jemalloc-sys-315785adf64e61f1/out/build/
  else
    export MALLOC_CONF= && \
    export_malloc_conf && \
    $JEMALLOC_TEST_PREFIX ${t} /mnt/hgfs/sanghaifa/data/examples/topic/rust-memory-leak/target/debug/build/jemalloc-sys-315785adf64e61f1/out/jemalloc/ /mnt/hgfs/sanghaifa/data/examples/topic/rust-memory-leak/target/debug/build/jemalloc-sys-315785adf64e61f1/out/build/
