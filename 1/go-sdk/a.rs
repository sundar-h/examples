...
#[test]
fn bindgen_test_layout_People() {
    assert_eq!(
        ::std::mem::size_of::<People>(),
        32usize,
        concat!("Size of: ", stringify!(People))
    );
    assert_eq!(
        ::std::mem::align_of::<People>(),
        8usize,
        concat!("Alignment of ", stringify!(People))
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<People>())).name as *const _ as usize },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(People),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<People>())).byte as *const _ as usize },
        16usize,
        concat!(
            "Offset of field: ",
            stringify!(People),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<People>())).age as *const _ as usize },
        24usize,
        concat!(
            "Offset of field: ",
            stringify!(People),
