...
extern "C" {
    pub fn init(config: *const ::std::os::raw::c_char) -> *const ::std::os::raw::c_char;
}
extern "C" {
    pub fn finalize() -> *const ::std::os::raw::c_char;
}
extern "C" {
...
extern "C" {
    pub fn send(payload: *const ::std::os::raw::c_char) -> *const ::std::os::raw::c_char;
}
extern "C" {
